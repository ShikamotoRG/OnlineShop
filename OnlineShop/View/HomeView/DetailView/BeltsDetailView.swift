...
struct BeltsDetailView: View {
    
    @State var viewModel: ProductDetailViewModel
    @State private var size = ""
    @State private var count = 1
    
    @State var uiImage = UIImage(named: "belt")
...
struct BeltsDetailView_Previews: PreviewProvider {
    static var previews: some View {
        BeltsDetailView(viewModel: ProductDetailViewModel(product: Product(id: "1",
                                                                             title: "Pants",
                                                                             imageUrl: "none",
                                                                             price: 49,
