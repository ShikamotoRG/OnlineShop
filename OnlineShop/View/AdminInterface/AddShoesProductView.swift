...
struct AddShoesProductView: View {
    ...
    var body: some View {
        VStack {
            ...
            Button {
                ...
                DatabaseService.shared.setShoes(product: product, image: imageData) { result in
                    switch result {
...
struct AddShoesProductView_Previews: PreviewProvider {
