...
struct AddTshirtProductView: View {
    ...
    var body: some View {
        VStack {
            ...
            Button {
                ...
                DatabaseService.shared.setTshirt(product: product, image: imageData) { result in
                    switch result {
...
struct AddTshirtProductView_Previews: PreviewProvider {
