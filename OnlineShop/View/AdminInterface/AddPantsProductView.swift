...
struct AddPantsProductView: View {
    ...
    var body: some View {
        VStack {
            ...
            Button {
                ...
                DatabaseService.shared.setPants(product: product, image: imageData) { result in
                    switch result {
...
struct AddPantsProductView_Previews: PreviewProvider {
