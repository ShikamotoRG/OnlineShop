...
struct AddJacketProductView: View {
    ...
    var body: some View {
        VStack {
            ...
            Button {
                ...
                DatabaseService.shared.setJacket(product: product, image: imageData) { result in
                    switch result {
...
struct AddJacketProductView_Previews: PreviewProvider {
