...
struct AddBeltsProductView: View {
    ...
    var body: some View {
        VStack {
            ...
            Button {
                ...
                DatabaseService.shared.setBelts(product: product, image: imageData) { result in
                    switch result {
...
struct AddBeltsProductView_Previews: PreviewProvider {
